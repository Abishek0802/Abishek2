<?php
include('config.php');
echo "<h2>Just sign up OR login</h2>";
?>
...
<style>
  ...
  * {
  ...
  form .btn .btn-layer {
    ...
    position: absolute;
    left: -100%;
    background: -webkit-linear-gradient(right, blue, blue, blue, blue);
    border-radius: 5px;
  ...
  .wrapper {
    ...
    box-shadow: 18px 18px 36px #afafaf,
  ...
  <div class="wrapper">
    ...
    <div class="form-container">
      ...
      <div class="form-inner">
        <form action="new.php" class="login" method="POST">
          <div class="field">
        ...
        <form action="new.php" class="signup" method="POST">
          <div class="field">
            <input type="text" placeholder="user name" name="name" required>
          </div>
          <div class="field">
            <input type="text" placeholder="Email address" name="email" parequired>
          </div>
          <div class="field">
